...
DISTDIR = /home/gnu/Documents/Codes/git/qPadNote/.tmp/qPadNote1.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = Backend.cpp \
		...
		TodoWindow.cpp \
		dataEngine.cpp \
		qPadNote.cpp qrc_ResourceFile.cpp \
		moc_Backend.cpp \
		moc_TodoBlock.cpp \
		moc_TodoWindow.cpp
OBJECTS       = Backend.o \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Backend.h TodoBlock.h TodoWindow.h dataEngine.h $(DISTDIR)/
	$(COPY_FILE) --parents Backend.cpp TodoBlock.cpp TodoWindow.cpp dataEngine.cpp qPadNote.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_Backend.cpp moc_TodoBlock.cpp moc_TodoWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Backend.cpp moc_TodoBlock.cpp moc_TodoWindow.cpp
moc_Backend.cpp: Backend.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/gnu/Documents/Codes/git/qPadNote/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/gnu/Documents/Codes/git/qPadNote -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/9.3.0 -I/usr/include/c++/9.3.0/x86_64-pc-linux-gnu -I/usr/include/c++/9.3.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.3.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.3.0/include-fixed -I/usr/include Backend.h -o moc_Backend.cpp
